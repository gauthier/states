...
class FinderComposerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBuildState()
    {
        ...
        $this->assertInstanceOf('\Teknoo\States\States\StateInterface', $stateObject);
    }
    ...
    public function testGetStateParentsClassesNamesList()
    {
        ...
        $this->assertEquals(
            array('Class1b\States\State4b', 'Teknoo\Tests\Support\MockState'),
            $this->finder->getStateParentsClassesNamesList('State5')
        );
        $this->assertEquals(
            array('Class1b\States\State5', 'Class1b\States\State4b', 'Teknoo\Tests\Support\MockState'),
